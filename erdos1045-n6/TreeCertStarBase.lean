...
def distances : List (Expr 4) := [(.div (.mul (.const (4)) (.sq (.mul (.var 0) (.const (-2))))) (.mul (.const (1)) (.add (.const (1)) (.sq (.var 0))))),
(.div (.mul (.const (4)) (.sq (.mul (.var 1) (.const (-2))))) (.mul (.const (1)) (.add (.const (1)) (.sq (.var 1))))),
(.div (.mul (.const (4)) (.sq (.mul (.var 2) (.const (-2))))) (.mul (.const (1)) (.add (.const (1)) (.sq (.var 2))))),
...
(.div (.mul (.const (4)) (.sq (.add (.mul (.var 2) (.const (-2))) (.mul (.var 0) (.const (2)))))) (.mul (.mul (.const (1)) (.add (.const (1)) (.sq (.var 0)))) (.add (.const (1)) (.sq (.var 2))))),
(.div (.mul (.const (4)) (.sq (.add (.mul (.var 3) (.const (-2))) (.mul (.var 0) (.const (2)))))) (.mul (.mul (.const (1)) (.add (.const (1)) (.sq (.var 0)))) (.add (.const (1)) (.sq (.var 3))))),
(.div (.mul (.const (4)) (.sq (.add (.mul (.var 2) (.const (-2))) (.mul (.var 1) (.const (2)))))) (.mul (.mul (.const (1)) (.add (.const (1)) (.sq (.var 1)))) (.add (.const (1)) (.sq (.var 2))))),
(.div (.mul (.const (4)) (.sq (.add (.mul (.var 3) (.const (-2))) (.mul (.var 1) (.const (2)))))) (.mul (.mul (.const (1)) (.add (.const (1)) (.sq (.var 1)))) (.add (.const (1)) (.sq (.var 3))))),
