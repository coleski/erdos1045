...
def distances : List (Expr 4) := [(.div (.mul (.const (4)) (.sq (.mul (.var 3) (.const (2))))) (.mul (.const (1)) (.add (.const (1)) (.sq (.var 3))))),
...
(.div (.mul (.const (4)) (.add (.sq (.add (.const (1)) (.mul (.var 2) (.mul (.var 3) (.const (3)))))) (.sq (.add (.mul (.var 3) (.const (1))) (.mul (.var 2) (.const (1))))))) (.mul (.mul (.const (1)) (.add (.const (1)) (.sq (.var 2)))) (.add (.const (1)) (.sq (.var 3)))))]
def i0 : Fin 4 := 0
def i1 : Fin 4 := 1
def i2 : Fin 4 := 2
def i3 : Fin 4 := 3
